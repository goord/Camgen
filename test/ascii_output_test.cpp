...
int main()
{
	...
	algo.construct();
        ...
        generator_interface<model_type,1,4>* gen_if=new generator_interface<model_type,1,4>(new ascii_file<model_type,1,4>(fname,"test tree"),new test_output<model_type,1,4>());
	...
	algo.construct_trees();
        ...
        generator_interface<model_type,2,4>* gen_if=new generator_interface<model_type,2,4>(new ascii_file<model_type,2,4>(fname,"test tree"),new test_output<model_type,2,4>());
        for(size_type i=0;i<n_evts;++i)
        {
            proc_gen->generate();
            gen_if->fill(proc_gen->get_event());
