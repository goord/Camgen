...
namespace Camgen
{
    ...
    template<class value_t>class Weyl_basis_clone::implementation<value_t,4,true>: public Dirac_algebra<value_t,implementation<value_t,4,true>,4,true>
    {
	public:
...
int main()
{
    ...
    std::cout<<"----------------------------------------------------------"<<std::endl;
    std::cout<<"testing spinor/vector wave functions in the Weyl basis...."<<std::endl;
    std::cout<<"----------------------------------------------------------"<<std::endl;
    ...
    typedef Weyl_basis::implementation<r_value_type,4> Dirac_algebra_type;
    typedef Weyl_basis_clone::implementation<r_value_type,4> Dirac_algebra_clone_type;
