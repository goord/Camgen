...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
* Tests for multichannel adaptations within the recursive Monte Carlo trees. *
*                                                                            *
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *  * * * */
...
int main()
{
    ...
    file_utils::create_directory("test_output/ps_tree_adapt_test");
	...
	std::string fname("test_output/ps_tree_adapt_test/h_4l");
	std::cerr<<"Checking "<<process<<"............";
	std::cerr.flush();
	...
	std::string fname("test_output/ps_tree_adapt_test/h_WW_2l2n");
	std::cerr<<"Checking "<<process<<"............";
	std::cerr.flush();
	CM_algorithm<model_type,1,4>algo(process);
	algo.load();
	...
	std::string fname("test_output/ps_tree_adapt_test/ee_ee");
	double E1=50;
	double E2=50;
	std::cerr<<"Checking "<<process<<"............";
	std::cerr.flush();
	...
	std::string fname("test_output/ps_tree_adapt_test/ee_h2n");
	double E1=250;
	double E2=250;
	std::cerr<<"Checking "<<process<<"............";
	std::cerr.flush();
	...
	std::string fname("test_output/ps_tree_adapt_test/ee_2W2n");
	double E1=250;
	double E2=250;
	double mmin=10;
	std::cerr<<"Checking "<<process<<"............";
	...
	std::string fname("test_output/ps_tree_adapt_test/ee_2Z2n");
	double E1=500;
	double E2=500;
	double mmin=10;
	std::cerr<<"Checking "<<process<<"............";
