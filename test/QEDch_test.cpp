...
int main()
{
    typedef QEDPbch::value_type value_type;
    ...
    std::cout<<"------------------------------------------------------------"<<std::endl;
    std::cout<<"testing QED amplitudes with continuous helicities..........."<<std::endl;
    std::cout<<"------------------------------------------------------------"<<std::endl;

    {
	CM_algorithm<QEDPbch,2,2>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,2,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,2>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    { 
	CM_algorithm<QEDPbch,2,2>algo(process,1);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,2,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,2>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDPbch,2,2>algo(process,2);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,2,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,2>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDPbch,2,2>algo(process,3);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,2,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,2>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDWbch,2,2>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDWbch,2,2,std::random>* gen=test_utils::test_generator_builder<QEDWbch,2,2>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDPbch,2,3>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking gauge invariance for "<<process<<"..........";
	std::cerr.flush();
	for(unsigned i=0;i<N_events;++i)
	{
    ...
    { 
	CM_algorithm<QEDPbch,2,3>algo(process,1);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 1 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,3>algo(process,2);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 2 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,3>algo(process,3);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 3 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,3>algo(process,4);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDWbch,2,3>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDWbch,2,3,std::random>* gen=test_utils::test_generator_builder<QEDWbch,2,3>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking Weyl-basis computation for "<<process<<"..........";
	std::cerr.flush();
	for(unsigned i=0;i<N_events;++i)
	{
    ...
    {
	CM_algorithm<QEDPbch,2,4>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking gauge invariance for "<<process<<"..........";
	std::cerr.flush();
	for(unsigned i=0;i<N_events;++i)
	{
    ...
    { 
	CM_algorithm<QEDPbch,2,4>algo(process,1);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 1 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,4>algo(process,2);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 2 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,4>algo(process,3);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 3 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,4>algo(process,4);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking particle 4 as final current for "<<process<<"..........";
    ...
    {
	CM_algorithm<QEDPbch,2,4>algo(process,5);
	algo.load();
	algo.construct();
	process_generator<QEDPbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDPbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
    ...
    {
	CM_algorithm<QEDWbch,2,4>algo(process);
	algo.load();
	algo.construct();
	process_generator<QEDWbch,2,4,std::random>* gen=test_utils::test_generator_builder<QEDWbch,2,4>::create_generator(algo.get_tree_iterator(),Ecm);
	std::cerr<<"Checking Weyl-basis computation for "<<process<<"..........";
	std::cerr.flush();
	for(unsigned i=0;i<N_events;++i)
	{
