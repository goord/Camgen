...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Testing facility for the Weyl basis implementation of the 4-dimensional Dirac *
 * algebra.  The overridden recursive relations in the Weyl basis class are      *
 * tested against the default full contractions in the base class by acting on   *
 * random spinors, vectors and scalars.                                          *
 *                                                                               *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
int main()
{
    ...
    std::cout<<"----------------------------------------------------------"<<std::endl;
    std::cout<<"testing gamma matrix algebra in the Weyl basis............"<<std::endl;
    std::cout<<"----------------------------------------------------------"<<std::endl;
    
    /* Useful type definitions: */

    typedef double value_type;
    typedef Camgen::Weyl_basis::implementation<value_type,4> Dirac_algebra_type;
