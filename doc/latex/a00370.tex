\hypertarget{a00370}{\section{Camgen\-:\-:model$<$ model\-\_\-t $>$ Class Template Reference}
\label{a00370}\index{Camgen\-::model$<$ model\-\_\-t $>$@{Camgen\-::model$<$ model\-\_\-t $>$}}
}
...
\hypertarget{a00370_a37ba372a5b17bbb43840f2f195b7622d}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-auxiliary\-\_\-particle@{add\-\_\-auxiliary\-\_\-particle}}
...
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a37ba372a5b17bbb43840f2f195b7622d}


Inserts spin-\/s auxiliary particle with name str. 

Auxiliary particles in Camgen do not propagate and have no wave functions. They can therefore not be selected as external particles. \hypertarget{a00370_aa1e50838292e002cb2997f8d34e376bf}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-auxiliary\-\_\-particle@{add\-\_\-auxiliary\-\_\-particle}}
\index{add\-\_\-auxiliary\-\_\-particle@{add\-\_\-auxiliary\-\_\-particle}!Camgen::model@{Camgen\-::model}}
...
\item[{const {\bf spin} \&}]{s}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_aa1e50838292e002cb2997f8d34e376bf}


Inserts spin-\/s auxiliary multiplet with name str in representation rep\-\_\-t. 

The rep\-\_\-t should be either adjoint\-\_\-rep$<$group\-\_\-t$>$ or fundamental\-\_\-rep$<$group\-\_\-t$>$ for some group type group\-\_\-t, or a composition thereof using the compose\-\_\-reps class template. Currently only the S\-U$<$\-N$>$ classes may serve as a group type. \hypertarget{a00370_a1a0e098a96a98c708e8d647e147eb9fe}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-fast\-\_\-4g\-\_\-vertex@{add\-\_\-fast\-\_\-4g\-\_\-vertex}}
...
\item[{void $\ast$}]{c0}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a1a0e098a96a98c708e8d647e147eb9fe}


Insert the fast 4-\/gluon vertex. 

Inserts an antisymmetric tensor field in the adjoint representation and a vertex of coupling it to 2 phi-\/particles an antisymmetric tensor coupling composed with f$<$ S\-U$<$\-N$>$ $>$. This will optimize gluon process performance. \hypertarget{a00370_a8d405f13336b9e6b339c62c40b73cd2b}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-fermions@{add\-\_\-fermions}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a8d405f13336b9e6b339c62c40b73cd2b}


Inserts a pair of conjugate Dirac fermions with names (str1,str2) and P\-D\-G-\/ids (n,-\/n). 

The first argument denotes the particle and the second one the anti-\/particle, e.\-g. add\-\_\-fermions(\char`\"{}e-\/\char`\"{},\char`\"{}e+\char`\"{},11) in \hyperlink{a00451}{Q\-E\-D}. \hypertarget{a00370_a72e2d95ddeb7b482732e86b7b45d4b9d}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-gluon@{add\-\_\-gluon}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a72e2d95ddeb7b482732e86b7b45d4b9d}


Insert a gluon of group group\-\_\-t in gauge g (name \char`\"{}g\char`\"{}, P\-D\-G-\/id 21). 

Equivalent to\-: add\-\_\-vector$<$adjoint\-\_\-rep$<$group\-\_\-t$>$,g$>$(\char`\"{}g\char`\"{},21). \hypertarget{a00370_a011d03cd0180b4b7fc6cfdee3444a43c}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-photon@{add\-\_\-photon}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a011d03cd0180b4b7fc6cfdee3444a43c}


Insert a photon in gauge g (name \char`\"{}gamma\char`\"{}, P\-D\-G-\/id 22). 

Equivalent to\-: add\-\_\-vector$<$g$>$(\char`\"{}gamma\char`\"{},22). \hypertarget{a00370_a3e03c5b326768183c974de1e3fa06fc1}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-quarks@{add\-\_\-quarks}}
...
\item[{int}]{n = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a3e03c5b326768183c974de1e3fa06fc1}


Inserts massless quarks with names (str1,str2) and P\-D\-G-\/ids (n,-\/n) in the fundamental representation of group\-\_\-t. 

Equivalent to\-: add\-\_\-fermions$<$ fundamental\-\_\-rep$<$group\-\_\-t$>$(str1,str2,n). \hypertarget{a00370_a865da3783727b5c5e33d3b7345eb0cf1}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-quarks@{add\-\_\-quarks}}
\index{add\-\_\-quarks@{add\-\_\-quarks}!Camgen::model@{Camgen\-::model}}
\subsubsection[{add\-\_\-quarks}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class model\-\_\-t$>$ template$<$class group\-\_\-t $>$ static void {\bf Camgen\-::model}$<$ model\-\_\-t $>$\-::add\-\_\-quarks (
\begin{DoxyParamCaption}
\item[{const std\-::string \&}]{str1, }
...
\item[{int}]{n = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a865da3783727b5c5e33d3b7345eb0cf1}


Inserts quarks with names (str1,str2), mass $\ast$m and P\-D\-G-\/ids (n,-\/n) in the fundamental representation of group\-\_\-t. 

Equivalent to\-: add\-\_\-fermions$<$ fundamental\-\_\-rep$<$group\-\_\-t$>$(str1,str2,m,n). \hypertarget{a00370_a3c1268dfedbc356a20a5fcd6febe8f3b}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-quarks@{add\-\_\-quarks}}
\index{add\-\_\-quarks@{add\-\_\-quarks}!Camgen::model@{Camgen\-::model}}
\subsubsection[{add\-\_\-quarks}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class model\-\_\-t$>$ template$<$class group\-\_\-t $>$ static void {\bf Camgen\-::model}$<$ model\-\_\-t $>$\-::add\-\_\-quarks (
\begin{DoxyParamCaption}
\item[{const std\-::string \&}]{str1, }
...
\item[{int}]{n = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a3c1268dfedbc356a20a5fcd6febe8f3b}
...
Equivalent to\-: add\-\_\-fermions$<$ fundamental\-\_\-rep$<$group\-\_\-t$>$(str1,str2,m,n). \hypertarget{a00370_abd07d9b401653097ac2bd08865a17d2b}{\index{Camgen\-::model@{Camgen\-::model}!add\-\_\-vertex@{add\-\_\-vertex}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_abd07d9b401653097ac2bd08865a17d2b}


Inserts a 3-\/vertex connecting particles phi1,phi2,\hyperlink{a00418}{phi3} by Feynman rule Feynrule\-\_\-t with couplings $\ast$c1(,$\ast$c2,$\ast$c3). 

Note that the couplings in vertex insertions should be of the type std\-::complex$<$value\-\_\-type$>$$\ast$ \hypertarget{a00370_af843c90460f953d8717728aa89d70552}{\index{Camgen\-::model@{Camgen\-::model}!couple\-\_\-particle@{couple\-\_\-particle}}
...
\item[{const std\-::string \&}]{phi}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_af843c90460f953d8717728aa89d70552}


Couples particle named phi. 

If phi is not found or not decoupled, no action is performed. \hypertarget{a00370_a1ada7c0d83308877cd41c28cf1c89be0}{\index{Camgen\-::model@{Camgen\-::model}!couple\-\_\-vertex@{couple\-\_\-vertex}}
...
\item[{const std\-::string \&}]{phi3}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a1ada7c0d83308877cd41c28cf1c89be0}


Couples the 3-\/vertices connecting phi1,phi2,\hyperlink{a00418}{phi3}. 

If no such vertex is found or no such vertex is decoupled, no action is performed. \hypertarget{a00370_a46c5d085b3af9acdfe0784662f572e28}{\index{Camgen\-::model@{Camgen\-::model}!decouple\-\_\-particle@{decouple\-\_\-particle}}
...
\item[{const std\-::string \&}]{phi}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a46c5d085b3af9acdfe0784662f572e28}


Decouples particle named phi from the rest. 

All vertices containing the particle will be disregarded during tree evaluations. If phi is not found, no action is performed. \hypertarget{a00370_ad9ef56b861b25d8f9440bd97f635cc40}{\index{Camgen\-::model@{Camgen\-::model}!decouple\-\_\-vertex@{decouple\-\_\-vertex}}
...
\item[{const std\-::string \&}]{phi3}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_ad9ef56b861b25d8f9440bd97f635cc40}


Decouples the 3-\/vertices connecting phi1,phi2,\hyperlink{a00418}{phi3}. 

If no such vertex is found or no such vertex is coupled, no action is performed. \hypertarget{a00370_aa517bf6e9bb16ca21999b4f96039e0d5}{\index{Camgen\-::model@{Camgen\-::model}!erase\-\_\-particle@{erase\-\_\-particle}}
...
\item[{const std\-::string \&}]{phi}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_aa517bf6e9bb16ca21999b4f96039e0d5}


Erases a particle named phi from the static list. 

If no such particle is found, no action is performed. Usage may lead to unexpected results as all previously built \hyperlink{a00070}{C\-M\-\_\-algorithm} trees become invalid. For a safer (and faster) way to omit particles, use decouple\-\_\-particle. \hypertarget{a00370_a8b0187733197a7fcbe21004033664b72}{\index{Camgen\-::model@{Camgen\-::model}!erase\-\_\-vertex@{erase\-\_\-vertex}}
...
\item[{const std\-::string \&}]{phi3}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a8b0187733197a7fcbe21004033664b72}


Erases the 3-\/vertices connecting phi1,phi2,\hyperlink{a00418}{phi3}. 

If no such vertex is found, no action is performed. Usage may lead to unexpected results as all previously built \hyperlink{a00070}{C\-M\-\_\-algorithm} trees become invalid. For a safer (and faster) way to omit interactions, use decouple\-\_\-vertex. \hypertarget{a00370_a761070785a66c0c840f1b08bece67b0f}{\index{Camgen\-::model@{Camgen\-::model}!erase\-\_\-vertex@{erase\-\_\-vertex}}
\index{erase\-\_\-vertex@{erase\-\_\-vertex}!Camgen::model@{Camgen\-::model}}
\subsubsection[{erase\-\_\-vertex}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class model\-\_\-t$>$ static void {\bf Camgen\-::model}$<$ model\-\_\-t $>$\-::erase\-\_\-vertex (
\begin{DoxyParamCaption}
\item[{const std\-::string \&}]{phi1, }
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a761070785a66c0c840f1b08bece67b0f}


Erases the 4-\/vertices connecting phi1,phi2,str3,str4. 

If no such vertex is found, no action is performed. \hypertarget{a00370_addb0565969863861ecfb72877717b1e6}{\index{Camgen\-::model@{Camgen\-::model}!get\-\_\-instance@{get\-\_\-instance}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_addb0565969863861ecfb72877717b1e6}


Returns the single instance of model\-\_\-t. 

If the instance is not yet allocated, uses the default constructor of model\-\_\-t to create and return it. \hypertarget{a00370_aac3264ce0db5925641f695c1b0fdfcac}{\index{Camgen\-::model@{Camgen\-::model}!initialise@{initialise}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_aac3264ce0db5925641f695c1b0fdfcac}


Creates the single instance of model\-\_\-t. 

Same functionality as the \hyperlink{a00370_addb0565969863861ecfb72877717b1e6}{get\-\_\-instance()}, but no return value. \hypertarget{a00370_abf489c248710fb84d0642590b1023db9}{\index{Camgen\-::model@{Camgen\-::model}!set\-\_\-complex\-\_\-mass\-\_\-scheme@{set\-\_\-complex\-\_\-mass\-\_\-scheme}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_abf489c248710fb84d0642590b1023db9}


Sets the complex mass scheme for all propagators (width included in spacelike propagators, allows exact gauge-\/invariance). 

\hypertarget{a00370_a89e70b576cf3cb5e345bd3252dc01373}{\index{Camgen\-::model@{Camgen\-::model}!set\-\_\-fixed\-\_\-width\-\_\-scheme@{set\-\_\-fixed\-\_\-width\-\_\-scheme}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_a89e70b576cf3cb5e345bd3252dc01373}


Sets the fixed width scheme for all propagators (no width included in spacelike propagators, not gauge-\/invariant). 

\hypertarget{a00370_adf237ebf4d679ef7cb395d15617a5b5b}{\index{Camgen\-::model@{Camgen\-::model}!set\-\_\-running\-\_\-width\-\_\-scheme@{set\-\_\-running\-\_\-width\-\_\-scheme}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{a00370_adf237ebf4d679ef7cb395d15617a5b5b}
...
include/\-Camgen/\hyperlink{a00675}{model.\-h}\end{DoxyCompactItemize}
