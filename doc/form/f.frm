...
L ADglu1=ADvertex(a1,a2,a3)*G2(a2)*G3(a3);
L ADglu2=ADvertex(a2,a1,a3)*G1(a2)*G3(a3);
L ADglu3=ADvertex(a3,a2,a1)*G1(a2)*G2(a3);
L ADscal=ADvertex(a1,a2,a3)*G1(a1)*G2(a2)*G3(a3);

*
* Vertex tensor definition in the adjoint representation:
*

L CFvertex=ADvertex(a1,a2,a3)*(2*t(a1,A1,B1))*(2*t(a2,A2,B2))*(2*t(a3,A3,B3));
...
id ADvertex(a1?,a2?,a3?)=f(a1,a2,a3);
...
*
* Fourth singlet recursive relation:
*
