...
L ADglu1=ADvertex(a1,A2,B3)*phi2(A2)*phi3(B3);
L ADphi2=ADvertex(a2,A1,B3)*G1(a2)*phi3(B3);
L ADphi3=ADvertex(a2,A3,B1)*G1(a2)*phi2(A3);
L ADscal=ADvertex(a1,A2,B3)*G1(a1)*phi2(A2)*phi3(B3);

*
* Vertex tensor definition in the adjoint representation:
*

L CFvertex=ADvertex(a1,A2,B3)*(2*t(a1,A1,B1));
...
id ADvertex(a1?,A2?,B3?)=t(a1,A2,B3);
...
*
* First (octet) recursive relation:
*

print CFglu1;

*
* Second (triplet) recursive relation:
*
