...
L ADglu1=ADvertex(a1,a2)*G2(a2);
L ADglu2=ADvertex(a2,a1)*G1(a2);
L ADscal=ADvertex(a1,a2)*G1(a1)*G2(a2);

*
* Vertex tensor definition in the adjoint representation:
*

L CFvertex=ADvertex(a1,a2)*(2*t(a1,A1,B1))*(2*t(a2,A2,B2));
