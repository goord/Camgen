...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Specialisation of the massless spinor factory class in the Pauli basis of     *
 * Dirac gamma matrices. This header cannot be compiled stand-alone, instead it  *
 * should be included through the files Pauli_basis.h or spinor_fac.h.           *
 *                                                                               *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

namespace Camgen
{
    template<class value_t>class massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>
    {
	public:
	    ...
	    typedef typename Pauli_basis::template implementation<r_value_type,4,true> Dirac_algebra_type;
	...
	public:
		...
		if(!initialised)
		{
		    ...
		    value_type c(std::sqrt((r_value_type)0.5),0);
		    u_p[0]=c;
		    u_p[1]=c;
		    u_p[2]=c;
		    u_p[3]=c;
		    ...
		    u_m_bar[2]=-c;
		    u_m_bar[3]=-c;
		    value_type c2((r_value_type)0.5,(r_value_type)0.5);
		    u_2_p[0]=c2;
		    u_2_p[1]=-std::conj(c2);
		    u_2_p[2]=c2;
		    u_2_p[3]=-std::conj(c2);
		...
		r_value_type factor=(r_value_type)0.5/(sqrt((*p)[0]-(*p)[1]));
		value_type chi1((*p)[0]-(*p)[1]+(*p)[3],(*p)[2]);
		chi1*=factor;
		value_type chi2(-(*p)[0]+(*p)[1]+(*p)[3],(*p)[2]);
		chi2*=factor;
		...
		r_value_type factor=(r_value_type)0.5/(std::sqrt((*p)[0]-(*p)[1]));
		value_type chi1((*p)[0]-(*p)[1]+(*p)[3],(*p)[2]);
		chi1*=(h*factor);
		value_type chi2(-(*p)[0]+(*p)[1]+(*p)[3],(*p)[2]);
		chi2*=(h*factor);
	    ...
	    {
		CAMGEN_MESSAGE("longitudinal massless polarisation vector construction called");
		return;
	    }
    ...
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_p(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_m(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_p_bar(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_m_bar(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_2_p(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::tensor_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::u_2_m(1,4);
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::momentum_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::k_0;
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::momentum_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::k_1;
    template<class value_t>typename massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::momentum_type massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::k_2;
    template<class value_t>const value_t massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::sqrthlf=std::sqrt((value_t)0.5);
    template<class value_t>bool massless_spinor_factory<typename Pauli_basis::template implementation<value_t,4,true>,3,4>::initialised=false;
}
