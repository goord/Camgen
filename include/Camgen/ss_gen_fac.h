...
namespace Camgen
{
	...
	public:
		...
		switch(s_pair_generation_mode())
		{
			...
			return new symmetric_s_generator_composition<value_t,rng_t>(s1_generator,s2_generator,s);
		    case s_pair_generation_modes::asymmetric:
			return new s_generator_composition<value_t,rng_t>(s1_generator,s2_generator,s);
		    case s_pair_generation_modes::hit_and_miss:
			return new symmetric_s_pair_generator<value_t,rng_t>(s1_generator,s2_generator,s);
		    default:
			return NULL;
		}
	    }
