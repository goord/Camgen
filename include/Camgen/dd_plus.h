...
#ifndef CAMGEN_DD_PLUS_H_
#define CAMGEN_DD_PLUS_H_

#include <Camgen/dd.h>
#include <Camgen/def_args.h>

/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Symmetrised double-Kronecker delta colour structure declaration and           *
 ...
 * with a colour-index symmetrised double Kronecker delta. There is also a       *
 * declaration and definition of the CF_dd class, which denotes the symmetric    *
...
namespace Camgen
{
	...
	/* Symmetrised double-Kronecker delta class for generic representation
	 * indices: */
	
	template<class rep_t,std::size_t I=0,std::size_t J=1,std::size_t K=2,std::size_t L=3>class dd_plus
	{
	    public:

		/* Self-referring type definition: */

		typedef dd_plus<rep_t,I,J,K,L> type;
		
		/* Colour-flow mode counterpart: */
		
		typedef dd_plus<rep_t,I,J,K,L> CF_type;
	...
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<rep_t,I,J,K,L>::rank;
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<rep_t,I,J,K,L>::tensor_size;
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<rep_t,I,J,K,L>::multiplicity;
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<rep_t,I,J,K,L>::contractions[4]={I,J,K,L};
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<rep_t,I,J,K,L>::ranges[4]={rep_t::dimension,rep_t::dimension,rep_t::dimension,rep_t::dimension};
	template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::string dd_plus<rep_t,I,J,K,L>::formula="(d(a1,a2)d(a3,a4)+d(a1,a4)d(a3,a2))";

	/* Declaration of the colour-flow symmetrised double-Kronecker delta: */

	template<std::size_t N,std::size_t I=0,std::size_t J=1,std::size_t K=2,std::size_t L=3>class CF_dd_plus;

	/* Specialisation in the case of the SU(N) adjoint representation: */

	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>class dd_plus<adjoint_rep< SU<N> >,I,J,K,L>
	{
	    public:

		/* Self-referring type definition: */

		typedef dd_plus<adjoint_rep< SU<N> >,I,J,K,L> type;
		
		/* Colour-flow mode counterpart: */
		
		typedef CF_dd_plus<N,I,J,K,L> CF_type;
	...
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::rank;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::tensor_size;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::multiplicity;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::contractions[4]={I,J,K,L};
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::ranges[4]={N*N-1,N*N-1,N*N-1,N*N-1};
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::string dd_plus<adjoint_rep<SU<N> >,I,J,K,L>::formula="(d(a1,a2)d(a3,a4)+d(a1,a4)d(a3,a2))";

	/* Definition of the colour-flow symmetrised double Kronecker delta: */

	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>class CF_dd_plus
	{
	    public:

		/* Self-referring type definition: */

		typedef CF_dd_plus<N,I,J,K,L> type;
	...
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t CF_dd_plus<N,I,J,K,L>::rank;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t CF_dd_plus<N,I,J,K,L>::tensor_size;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t CF_dd_plus<N,I,J,K,L>::multiplicity;
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t CF_dd_plus<N,I,J,K,L>::contractions[4]={I,J,K,L};
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::size_t CF_dd_plus<N,I,J,K,L>::ranges[4]={N*N,N*N,N*N,N*N};
	template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L>const std::string CF_dd_plus<N,I,J,K,L>::formula="4(d(A1,B2)d(A2,B1)d(A3,B4)d(A4,B3)+d(A1,B4)d(A2,B3)d(A3,B2)d(A4,B1)-d(A1,B1)d(A2,B2)d(A3,B4)d(A4,B3)/N-d(A1,B1)d(A2,B3)d(A3,B2)d(A4,B4)/N-d(A1,B2)d(A2,B1)d(A3,B3)d(A4,B4)/N-d(A1,B4)d(A2,B2)d(A3,B3)d(A4,B1)/N+2d(A1,B1)d(A2,B2)d(A3,B3)d(A4,B4)/N^2)";
    }
    
    /* Specialisation for the evaluate class template for generic symmetrised
     * double Kronecker delta compositions: */

    template<class rep_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L,class Feynrule_t>class evaluate<compose_vertices<colour_tensor::dd_plus<rep_t,I,J,K,L>,Feynrule_t> >
    {
	public:
	    
	    /* Vertex class type definition: */

	    typedef compose_vertices<colour_tensor::dd_plus<rep_t,I,J,K,L>,Feynrule_t> vertex_type;
    ...
    /* Evaluate class template specialisation for the colour-flow symmetrised
     * double Kronecker delta colour structures: */
    
    template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L,class Feynrule_t>class evaluate<compose_vertices<colour_tensor::CF_dd_plus<N,I,J,K,L>,Feynrule_t> >
    {
	public:
	    
	    /* Vertex class type definition: */

	    typedef compose_vertices<colour_tensor::CF_dd_plus<N,I,J,K,L>,Feynrule_t> vertex_type;
    ...
    /* Specialisation of the cfd_evaluate class template for the symmetrised
     * double Kronecker delta colour structures over SU(N)-fundamental
     * representation indices: */

    template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L,class Feynrule_t>class cfd_evaluate<compose_vertices<colour_tensor::dd_plus<fundamental_rep< SU<N> >,I,J,K,L>,Feynrule_t> >
    {
	public:

	    /* Vertex class type definition: */

	    typedef compose_vertices<colour_tensor::dd_plus<fundamental_rep< SU<N> >,I,J,K,L>,Feynrule_t> vertex_type;
    ...
    /* Specialisation of the cfd_evaluate class template for symmetrised double
     * Kronecker delta colour structures over SU(N)-adjoint representation
     * indices: */

    template<std::size_t N,std::size_t I,std::size_t J,std::size_t K,std::size_t L,class Feynrule_t>class cfd_evaluate<compose_vertices<colour_tensor::CF_dd_plus<N,I,J,K,L>,Feynrule_t> >
    {
	public:
