...
#ifndef CAMGEN_TT_HELPER_H_
#define CAMGEN_TT_HELPER_H_

#include <Camgen/eval.h>
#include <Camgen/rep.h>

/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Helper class for the TT-vertex colour structure. It lists the nonzero       *
 * generator matrix product components in a recursion relation to optimise the *
...
namespace Camgen
{
    ...
    {
	template<class rep_t,class Feynrule_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>class TT_helper
	{
	    public:
	...
	template<class rep_t,class Feynrule_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>bool TT_helper<rep_t,Feynrule_t,I,J,K,L>::initialised=false;
	template<class rep_t,class Feynrule_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>std::vector<typename TT_helper<rep_t,Feynrule_t,I,J,K,L>::value_type> TT_helper<rep_t,Feynrule_t,I,J,K,L>::values;
	template<class rep_t,class Feynrule_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>std::vector<int> TT_helper<rep_t,Feynrule_t,I,J,K,L>::jumps[4];
	template<class rep_t,class Feynrule_t,std::size_t I,std::size_t J,std::size_t K,std::size_t L>typename TT_helper<rep_t,Feynrule_t,I,J,K,L>::size_type TT_helper<rep_t,Feynrule_t,I,J,K,L>::backsets[4]={0,0,0,0};
    }
}

#endif /*CAMGEN_TT_HELPER_H_*/
