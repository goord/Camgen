...
#ifndef CAMGEN_WEYL_BASIS_H_
#define CAMGEN_WEYL_BASIS_H_

#include <Camgen/Minkowski.h>
#include <Camgen/Dirac_alg.h>

/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Declaration and definition of the Weyl basis of Dirac gamma matrices. Aside   *
...
namespace Camgen
{
    ...
    template<class value_t>class Weyl_basis::implementation<value_t,4,true>: public Dirac_algebra<value_t,implementation<value_t,4,true>,4,true>
    {
	public:
		...
		base_type::g[0][0][2]=value_type(1,0);
		base_type::g[0][1][3]=value_type(1,0);
		base_type::g[0][2][0]=value_type(1,0);
		base_type::g[0][3][1]=value_type(1,0);
		...
		base_type::g_5[0][0]=value_type(-1,0);
		base_type::g_5[1][1]=value_type(-1,0);
		base_type::g_5[2][2]=value_type(1,0);
		base_type::g_5[3][3]=value_type(1,0);
		...
		base_type::C_matrix[0][1]=value_type(1,0);
		base_type::C_matrix[1][0]=value_type(-1,0);
		base_type::C_matrix[2][3]=value_type(-1,0);
		base_type::C_matrix[3][2]=value_type(1,0);
		...
		x+=(A_1[0]*A_2[1]-A_1[1]*A_2[0]-A_1[2]*A_2[3]+A_1[3]*A_2[2]);
		...
		value_type Qp=A_1[0]*A_2[2] + A_1[3]*A_2[1];

		value_type Qm=A_1[1]*A_2[3] + A_1[2]*A_2[0];

		value_type Pp=A_1[0]*A_2[3] - A_1[2]*A_2[1];

		value_type Pm=A_1[1]*A_2[2] - A_1[3]*A_2[0];

		A_0[0] += C_0*(Qp + Qm);

		A_0[1] += C_0*(Pp + Pm);

		A_0[2] += C_0*(value_type(Pp.imag()-Pm.imag(),Pm.real()-Pp.real()));
		...
		value_type Pp=A_0[0]+A_0[3];

		value_type Pm=A_0[0]-A_0[3];

		A_1[0] += C_0*(Pm*A_2[2] - Qm*A_2[3]);

		A_1[1] -= C_0*(Qp*A_2[2] - Pp*A_2[3]);

		A_1[2] += C_0*(Pp*A_2[0] + Qm*A_2[1]);

		A_1[3] += C_0*(Qp*A_2[0] + Pm*A_2[1]);
		...
		r_value_type Pp=A_0[0]+A_0[3];

		r_value_type Pm=A_0[0]-A_0[3];

		A_1[0] += C_0*(Pm*A_2[2] - std::conj(Qp)*A_2[3]);

		A_1[1] -= C_0*(Qp*A_2[2] - Pp*A_2[3]);

		A_1[2] += C_0*(Pp*A_2[0] + std::conj(Qp)*A_2[1]);
		...
		A_2[0] += C_0*(Pp*A_1[2] + Qp*A_1[3]);

		A_2[1] += C_0*(Qm*A_1[2] + Pm*A_1[3]);

		A_2[2] += C_0*(Pm*A_1[0] - Qp*A_1[1]);

		A_2[3] -= C_0*(Qm*A_1[0] - Pp*A_1[1]);
		...
		A_2[1] += C_0*(std::conj(Qp)*A_1[2] + Pm*A_1[3]);

		A_2[2] += C_0*(Pm*A_1[0] - Qp*A_1[1]);

		A_2[3] -= C_0*(std::conj(Qp)*A_1[0] - Pp*A_1[1]);
		...
		value_type Qp=-A_1[0]*A_2[3] - A_1[3]*A_2[0];

		value_type Qm=A_1[1]*A_2[2] + A_1[2]*A_2[1];

		value_type Pp=A_1[0]*A_2[2] + A_1[2]*A_2[0];

		value_type Pm=-A_1[1]*A_2[3] - A_1[3]*A_2[1];
		...
		A_1[0] -= C_0*(Pm*A_2[3] + Qm*A_2[2]);

		A_1[1] += C_0*(Qp*A_2[3] + Pp*A_2[2]);

		A_1[2] += C_0*(Pp*A_2[1] - Qm*A_2[0]);

		A_1[3] += C_0*(Qp*A_2[1] - Pm*A_2[0]);
		...
		A_2[0] -= C_0*(Qm*A_1[2] + Pm*A_1[3]);

		A_2[1] += C_0*(Pp*A_1[2] + Qp*A_1[3]);

		A_2[2] -= C_0*(Qm*A_1[0] - Pp*A_1[1]);

		A_2[3] -= C_0*(Pm*A_1[0] - Qp*A_1[1]);
		...
		value_type Qp=-A_1[1]*A_2[2] - A_1[2]*A_2[1];

		value_type Qm=A_1[0]*A_2[3] + A_1[3]*A_2[0];

		value_type Pp=-A_1[1]*A_2[3] - A_1[3]*A_2[1];

		value_type Pm=A_1[0]*A_2[2] + A_1[2]*A_2[0];
		...
		A_1[0] -= C_0*(Qp*A_2[2] - Pp*A_2[3]);

		A_1[1] -= C_0*(Pm*A_2[2] - Qm*A_2[3]);

		A_1[2] -= C_0*(Qp*A_2[0] + Pm*A_2[1]);

		A_1[3] += C_0*(Pp*A_2[0] + Qm*A_2[1]);
		...
		A_2[0] += C_0*(Pp*A_1[3] - Qp*A_1[2]);

		A_2[1] += C_0*(Qm*A_1[3] - Pm*A_1[2]);

		A_2[2] -= C_0*(Pm*A_1[1] + Qp*A_1[0]);

		A_2[3] += C_0*(Qm*A_1[1] + Pp*A_1[0]);
		...
		A_0[0]+=((C_0-C_1)*(A_1[0]*A_2[0]+A_1[1]*A_2[1]));
		A_0[0]+=((C_0+C_1)*(A_1[2]*A_2[2]+A_1[3]*A_2[3]));
		...
		value_type c1=(C_0+C_1)*A_0[0];
		value_type c2=(C_0-C_1)*A_0[0];
		...
		A_0[0]+=((C_0-C_1)*(A_1[0]*A_2[1]-A_1[1]*A_2[0]));
		A_0[0]+=((C_0+C_1)*(-A_1[2]*A_2[3]+A_1[3]*A_2[2]));
		...
		A_0[0]+=C_0*(A_1[2]*A_2[2]+A_1[3]*A_2[3]);
		...
		A_1[2]+=(C_0*A_0[0]*A_2[2]);
		A_1[3]+=(C_0*A_0[0]*A_2[3]);
		...
		A_2[2]+=(C_0*A_0[0]*A_1[2]);
		A_2[3]+=(C_0*A_0[0]*A_1[3]);
		...
		A_0[0]+=C_0*(A_1[3]*A_2[2]-A_1[2]*A_2[3]);
		...
		A_1[2]-=(C_0*A_0[0]*A_2[3]);
		A_1[3]+=(C_0*A_0[0]*A_2[2]);
		...
		A_2[2]+=(C_0*A_0[0]*A_1[3]);
		A_2[3]-=(C_0*A_0[0]*A_1[2]);
		...
		A_0[0]+=C_0*(A_1[0]*A_2[0]+A_1[1]*A_2[1]);
		...
		A_1[0]+=(C_0*A_0[0]*A_2[0]);
		A_1[1]+=(C_0*A_0[0]*A_2[1]);
		...
		A_2[0]+=(C_0*A_0[0]*A_1[0]);
		A_2[1]+=(C_0*A_0[0]*A_1[1]);
		...
		A_0[0]+=C_0*(A_1[0]*A_2[1]-A_1[1]*A_2[0]);
		...
		A_1[0]+=(C_0*A_0[0]*A_2[1]);
		A_1[1]-=(C_0*A_0[0]*A_2[0]);
		...
		A_2[0]-=(C_0*A_0[0]*A_1[1]);
		A_2[1]+=(C_0*A_0[0]*A_1[0]);
		...
		A_0[0]+=(C_1*(A_1[0]*A_2[0]+A_1[1]*A_2[1]));
		A_0[0]+=(C_0*(A_1[2]*A_2[2]+A_1[3]*A_2[3]));
		...
		A_0[0]+=(C_1*(A_1[0]*A_2[1]-A_1[1]*A_2[0]));
		A_0[0]+=(C_0*(-A_1[2]*A_2[3]+A_1[3]*A_2[2]));
		...
		value_type L=C_0+C_1;

		value_type R=C_0-C_1;

		A_0[0] += (L*(A_1[0]*A_2[2]+A_1[1]*A_2[3])+R*(A_1[2]*A_2[0]+A_1[3]*A_2[1]));

		A_0[1] += (L*(A_1[1]*A_2[2]+A_1[0]*A_2[3])-R*(A_1[2]*A_2[1]+A_1[3]*A_2[0]));

		A_0[2] += times_i(L*(A_1[1]*A_2[2]-A_1[0]*A_2[3])+R*(A_1[2]*A_2[1]-A_1[3]*A_2[0]));

		A_0[3] += (L*(A_1[0]*A_2[2]-A_1[1]*A_2[3])+R*(-A_1[2]*A_2[0]+A_1[3]*A_2[1]));
		...
		A_1[0] += L*((A_0[0]-A_0[3])*A_2[2]-Qm*A_2[3]);

		A_1[1] += L*(-Qp*A_2[2]+(A_0[0]+A_0[3])*A_2[3]);

		A_1[2] += R*((A_0[0]+A_0[3])*A_2[0]+Qm*A_2[1]);

		A_1[3] += R*(Qp*A_2[0]+(A_0[0]-A_0[3])*A_2[1]);
		...
		A_2[0] += R*((A_0[0]+A_0[3])*A_1[2]+Qp*A_1[3]);

		A_2[1] += R*(Qm*A_1[2]+(A_0[0]-A_0[3])*A_1[3]);

		A_2[2] += L*((A_0[0]-A_0[3])*A_1[0]-Qp*A_1[1]);

		A_2[3] += L*(-Qm*A_1[0]+(A_0[0]+A_0[3])*A_1[1]);
		...
		A_0[0] += (L*(-A_1[0]*A_2[3]+A_1[1]*A_2[2])+R*(A_1[2]*A_2[1]-A_1[3]*A_2[0]));

		A_0[1] += (L*(-A_1[1]*A_2[3]+A_1[0]*A_2[2])+R*(A_1[2]*A_2[0]-A_1[3]*A_2[1]));

		A_0[2] += times_i(L*(-A_1[1]*A_2[3]-A_1[0]*A_2[2])-R*(A_1[2]*A_2[0]+A_1[3]*A_2[1]));

		A_0[3] += (L*(-A_1[0]*A_2[3]-A_1[1]*A_2[2])-R*(A_1[2]*A_2[1]+A_1[3]*A_2[0]));
		...
		A_1[0] += L*((A_0[3]-A_0[0])*A_2[3]-Qm*A_2[2]);

		A_1[1] += L*(Qp*A_2[3]+(A_0[0]+A_0[3])*A_2[2]);

		A_1[2] += R*((A_0[0]+A_0[3])*A_2[1]-Qm*A_2[0]);

		A_1[3] += R*(Qp*A_2[1]+(A_0[3]-A_0[0])*A_2[0]);
		...
		A_2[0] -= R*(Qm*A_1[2]+(A_0[0]-A_0[3])*A_1[3]);

		A_2[1] += R*((A_0[0]+A_0[3])*A_1[2]+Qp*A_1[3]);

		A_2[2] += L*(-Qm*A_1[0]+(A_0[0]+A_0[3])*A_1[1]);

		A_2[3] -= L*((A_0[0]-A_0[3])*A_1[0]-Qp*A_1[1]);
		...
		A_0[0] += (L*(-A_1[1]*A_2[2]+A_1[0]*A_2[3])+R*(A_1[3]*A_2[0]-A_1[2]*A_2[1]));

		A_0[1] += (L*(A_1[0]*A_2[2]-A_1[1]*A_2[3])-R*(A_1[3]*A_2[1]-A_1[2]*A_2[0]));

		A_0[2] += times_i(L*(A_1[0]*A_2[2]+A_1[1]*A_2[3])+R*(A_1[3]*A_2[1]+A_1[2]*A_2[0]));

		A_0[3] -= (L*(A_1[1]*A_2[2]+A_1[0]*A_2[3])+R*(A_1[3]*A_2[0]+A_1[2]*A_2[1]));
		...
		A_1[0] -= L*(Qp*A_2[2]-(A_0[0]+A_0[3])*A_2[3]);

		A_1[1] -= L*((A_0[0]-A_0[3])*A_2[2]-Qm*A_2[3]);

		A_1[2] -= R*(Qp*A_2[0]+(A_0[0]-A_0[3])*A_2[1]);

		A_1[3] += R*((A_0[0]+A_0[3])*A_2[0]+Qm*A_2[1]);
		...
		A_2[0] += R*((A_0[0]+A_0[3])*A_1[3]-Qp*A_1[2]);

		A_2[1] += R*(Qm*A_1[3]-(A_0[0]-A_0[3])*A_1[2]);

		A_2[2] += L*((A_0[3]-A_0[0])*A_1[1]-Qp*A_1[0]);

		A_2[3] += L*(Qm*A_1[1]+(A_0[0]+A_0[3])*A_1[0]);
		...
		A_0[0] += C_0*(A_1[0]*A_2[2] + A_1[1]*A_2[3]);

		A_0[1] += C_0*(A_1[0]*A_2[3] + A_1[1]*A_2[2]);

		A_0[2] += C_0*times_i(A_1[1]*A_2[2]-A_1[0]*A_2[3]);

		A_0[3] += C_0*(A_1[0]*A_2[2] - A_1[1]*A_2[3]);
		...
		A_1[0] += C_0*((A_0[0]-A_0[3])*A_2[2] - value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[3]);

		A_1[1] -= C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[2] - (A_0[0]+A_0[3])*A_2[3]);
		...
		A_2[2] += C_0*((A_0[0]-A_0[3])*A_1[0] - value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[1]);

		A_2[3] -= C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[0] - (A_0[0]+A_0[3])*A_1[1]);
		...
		A_0[0] += C_0*(-A_1[0]*A_2[3] + A_1[1]*A_2[2]);

		A_0[1] += C_0*(A_1[0]*A_2[2] - A_1[1]*A_2[3]);

		A_0[2] -= C_0*times_i(A_1[1]*A_2[3] + A_1[0]*A_2[2]);

		A_0[3] -= C_0*(A_1[0]*A_2[3] + A_1[1]*A_2[2]);
		...
		A_1[0] -= C_0*((A_0[0]-A_0[3])*A_2[3] + value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[2]);

		A_1[1] += C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[3] + (A_0[0]+A_0[3])*A_2[2]);
		...
		A_2[2] -= C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[0] - (A_0[0]+A_0[3])*A_1[1]);

		A_2[3] -= C_0*((A_0[0]-A_0[3])*A_1[0] - value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[1]);
		...
		A_0[0] += C_0*(-A_1[1]*A_2[2] + A_1[0]*A_2[3]);

		A_0[1] += C_0*(-A_1[1]*A_2[3] + A_1[0]*A_2[2]);

		A_0[2] += C_0*times_i(A_1[0]*A_2[2] + A_1[1]*A_2[3]);

		A_0[3] += C_0*(-A_1[1]*A_2[2] - A_1[0]*A_2[3]);
		...
		A_1[0] -= C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[2] - (A_0[0]+A_0[3])*A_2[3]);

		A_1[1] -= C_0*((A_0[0]-A_0[3])*A_2[2] - value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[3]);
		...
		A_2[2] += C_0*((A_0[3]-A_0[0])*A_1[1] - value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[0]);

		A_2[3] += C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[1] + (A_0[0]+A_0[3])*A_1[0]);
		...
		A_0[0] += C_0*(A_1[3]*A_2[1] + A_1[2]*A_2[0]);

		A_0[1] -= C_0*(A_1[2]*A_2[1] + A_1[3]*A_2[0]);

		A_0[2] += C_0*times_i(A_1[2]*A_2[1] - A_1[3]*A_2[0]);

		A_0[3] += C_0*(A_1[3]*A_2[1] - A_1[2]*A_2[0]);
		...
		A_1[2] += C_0*((A_0[0]+A_0[3])*A_2[0] + value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[1]);

		A_1[3] += C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[0] + (A_0[0]-A_0[3])*A_2[1]);
		...
		A_2[0] += C_0*((A_0[0]+A_0[3])*A_1[2] + value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[3]);

		A_2[1] += C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[2] + (A_0[0]-A_0[3])*A_1[3]);
		...
		A_0[0] += C_0*(-A_1[3]*A_2[0] + A_1[2]*A_2[1]);

		A_0[1] += C_0*(A_1[2]*A_2[0] - A_1[3]*A_2[1]);

		A_0[2] -= C_0*times_i(A_1[2]*A_2[0] + A_1[3]*A_2[1]);

		A_0[3] -= C_0*(A_1[3]*A_2[0] + A_1[2]*A_2[1]);
		...
		A_1[2] += C_0*((A_0[0]+A_0[3])*A_2[1] - value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[0]);

		A_1[3] += C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[1] - (A_0[0]-A_0[3])*A_2[0]);
		...
		A_2[0] -= C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[2] + (A_0[0]-A_0[3])*A_1[3]);

		A_2[1] += C_0*((A_0[0]+A_0[3])*A_1[2] + value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[3]);
		...
		A_0[0] += C_0*(-A_1[2]*A_2[1] + A_1[3]*A_2[0]);

		A_0[1] -= C_0*(A_1[3]*A_2[1] - A_1[2]*A_2[0]);

		A_0[2] += C_0*times_i(A_1[3]*A_2[1] + A_1[2]*A_2[0]);

		A_0[3] -= C_0*(A_1[2]*A_2[1] + A_1[3]*A_2[0]);
		...
		A_1[2] -= C_0*(value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_2[0] + (A_0[0]-A_0[3])*A_2[1]);

		A_1[3] += C_0*((A_0[0]+A_0[3])*A_2[0] + value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_2[1]);
		...
		A_2[0] += C_0*((A_0[0]+A_0[3])*A_1[3] - value_type(A_0[1].real()-A_0[2].imag(),A_0[1].imag()+A_0[2].real())*A_1[2]);

		A_2[1] += C_0*(value_type(A_0[1].real()+A_0[2].imag(),A_0[1].imag()-A_0[2].real())*A_1[3] - (A_0[0]-A_0[3])*A_1[2]);
		...
		A_0[0] += (C_0*(A_1[0]*A_2[2]+A_1[1]*A_2[3])+C_1*(A_1[2]*A_2[0]+A_1[3]*A_2[1]));

		A_0[1] += (C_0*(A_1[1]*A_2[2]+A_1[0]*A_2[3])-C_1*(A_1[2]*A_2[1]+A_1[3]*A_2[0]));

		A_0[2] += times_i(C_0*(A_1[1]*A_2[2]-A_1[0]*A_2[3])+C_1*(A_1[2]*A_2[1]-A_1[3]*A_2[0]));

		A_0[3] += (C_0*(A_1[0]*A_2[2]-A_1[1]*A_2[3])+C_1*(-A_1[2]*A_2[0]+A_1[3]*A_2[1]));
		...
		A_1[0] += C_0*((A_0[0]-A_0[3])*A_2[2]-Qm*A_2[3]);

		A_1[1] += C_0*(-Qp*A_2[2]+(A_0[0]+A_0[3])*A_2[3]);

		A_1[2] += C_1*((A_0[0]+A_0[3])*A_2[0]+Qm*A_2[1]);

		A_1[3] += C_1*(Qp*A_2[0]+(A_0[0]-A_0[3])*A_2[1]);
		...
		A_2[0] += C_1*((A_0[0]+A_0[3])*A_1[2]+Qp*A_1[3]);

		A_2[1] += C_1*(Qm*A_1[2]+(A_0[0]-A_0[3])*A_1[3]);

		A_2[2] += C_0*((A_0[0]-A_0[3])*A_1[0]-Qp*A_1[1]);

		A_2[3] += C_0*(-Qm*A_1[0]+(A_0[0]+A_0[3])*A_1[1]);
		...
		A_0[0] += (C_0*(-A_1[0]*A_2[3]+A_1[1]*A_2[2])+C_1*(A_1[2]*A_2[1]-A_1[3]*A_2[0]));

		A_0[1] += (C_0*(-A_1[1]*A_2[3]+A_1[0]*A_2[2])+C_1*(A_1[2]*A_2[0]-A_1[3]*A_2[1]));

		A_0[2] += times_i(C_0*(-A_1[1]*A_2[3]-A_1[0]*A_2[2])-C_1*(A_1[2]*A_2[0]+A_1[3]*A_2[1]));

		A_0[3] += (C_0*(-A_1[0]*A_2[3]-A_1[1]*A_2[2])-C_1*(A_1[2]*A_2[1]+A_1[3]*A_2[0]));
		...
		A_1[0] += C_0*((A_0[3]-A_0[0])*A_2[3]-Qm*A_2[2]);

		A_1[1] += C_0*(Qp*A_2[3]+(A_0[0]+A_0[3])*A_2[2]);

		A_1[2] += C_1*((A_0[0]+A_0[3])*A_2[1]-Qm*A_2[0]);

		A_1[3] += C_1*(Qp*A_2[1]+(A_0[3]-A_0[0])*A_2[0]);
		...
		A_2[0] -= C_1*(Qm*A_1[2]+(A_0[0]-A_0[3])*A_1[3]);

		A_2[1] += C_1*((A_0[0]+A_0[3])*A_1[2]+Qp*A_1[3]);

		A_2[2] += C_0*(-Qm*A_1[0]+(A_0[0]+A_0[3])*A_1[1]);

		A_2[3] -= C_0*((A_0[0]-A_0[3])*A_1[0]-Qp*A_1[1]);
		...
		A_0[0] += (C_0*(-A_1[1]*A_2[2]+A_1[0]*A_2[3])+C_1*(A_1[3]*A_2[0]-A_1[2]*A_2[1]));

		A_0[1] += (C_0*(A_1[0]*A_2[2]-A_1[1]*A_2[3])-C_1*(A_1[3]*A_2[1]-A_1[2]*A_2[0]));

		A_0[2] += times_i(C_0*(A_1[0]*A_2[2]+A_1[1]*A_2[3])+C_1*(A_1[3]*A_2[1]+A_1[2]*A_2[0]));

		A_0[3] -= (C_0*(A_1[1]*A_2[2]+A_1[0]*A_2[3])+C_1*(A_1[3]*A_2[0]+A_1[2]*A_2[1]));
		...
		A_1[0] -= C_0*(Qp*A_2[2]-(A_0[0]+A_0[3])*A_2[3]);

		A_1[1] -= C_0*((A_0[0]-A_0[3])*A_2[2]-Qm*A_2[3]);

		A_1[2] -= C_1*(Qp*A_2[0]+(A_0[0]-A_0[3])*A_2[1]);

		A_1[3] += C_1*((A_0[0]+A_0[3])*A_2[0]+Qm*A_2[1]);
		...
		A_2[0] += C_1*((A_0[0]+A_0[3])*A_1[3]-Qp*A_1[2]);

		A_2[1] += C_1*(Qm*A_1[3]-(A_0[0]-A_0[3])*A_1[2]);

		A_2[2] += C_0*((A_0[3]-A_0[0])*A_1[1]-Qp*A_1[0]);

		A_2[3] += C_0*(Qm*A_1[1]+(A_0[0]+A_0[3])*A_1[0]);
		...
		value_type Pp=p[0]+p[3];

		value_type Pm=p[0]-p[3];

		value_type temp0 = C_0*(Pm*A_0[2] - std::conj(Qp)*A_0[3]);

		value_type temp1 = C_0*(-Qp*A_0[2] + Pp*A_0[3]);

		A_0[2] = C_0*(Pp*A_0[0] + std::conj(Qp)*A_0[1]);

		A_0[3] = C_0*(Qp*A_0[0] + Pm*A_0[1]);
		...
		do
		{
		    temp0 = C_0*(Pm*A_0[2] - std::conj(Qp)*A_0[3]);

		    temp1 = C_0*(-Qp*A_0[2] + Pp*A_0[3]);
		...
		value_type temp0 = C_0*(Pm*A_0[2] - std::conj(Qp)*A_0[3] + m*A_0[0]);

		value_type temp1 = C_0*(-Qp*A_0[2] + Pp*A_0[3] + m*A_0[1]);

		A_0[2] = C_0*(Pp*A_0[0] + std::conj(Qp)*A_0[1] + m*A_0[2]);

		A_0[3] = C_0*(Qp*A_0[0] + Pm*A_0[1] + m*A_0[3]);
		...
		do
		{
		    temp0 = C_0*(Pm*A_0[2] - std::conj(Qp)*A_0[3] + m*A_0[0]);

		    temp1 = C_0*(-Qp*A_0[2] + Pp*A_0[3] + m*A_0[1]);
		...
		value_type temp0 = C_0*(-Pp*A_0[2] - Qp*A_0[3]);

		value_type temp1 = C_0*(-std::conj(Qp)*A_0[2] - Pm*A_0[3]);

		A_0[2] = C_0*(-Pm*A_0[0] + Qp*A_0[1]);

		A_0[3] = C_0*(std::conj(Qp)*A_0[0] - Pp*A_0[1]);
		...
		do
		{
		    temp0 = C_0*(-Pp*A_0[2] - Qp*A_0[3]);

		    temp1 = C_0*(-std::conj(Qp)*A_0[2] - Pm*A_0[3]);
		...
		value_type temp0 = C_0*(-Pp*A_0[2] - Qp*A_0[3] + m*A_0[0]);

		value_type temp1 = C_0*(-std::conj(Qp)*A_0[2] - Pm*A_0[3] + m*A_0[1]);

		A_0[2] = C_0*(-Pm*A_0[0] + Qp*A_0[1] + m*A_0[2]);

		A_0[3] = C_0*(std::conj(Qp)*A_0[0] - Pp*A_0[1] + m*A_0[3]);
		...
		do
		{
		    temp0 = C_0*(-Pp*A_0[2] - Qp*A_0[3] + m*A_0[0]);

		    temp1 = C_0*(-std::conj(Qp)*A_0[2] - Pm*A_0[3] + m*A_0[1]);
    ...
    template<class value_t>const int Weyl_basis::implementation<value_t,4,true>::eta_g;
    template<class value_t>const int Weyl_basis::implementation<value_t,4,true>::eta_g5;
    template<class value_t>const int Weyl_basis::implementation<value_t,4,true>::eta_gg5;
    template<class value_t>const int Weyl_basis::implementation<value_t,4,true>::eta_gg;
}
