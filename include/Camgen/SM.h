...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Declaration of the standard model class in Camgen. The coupling constant   *
 * values may be inserted manually, or computed by the class from the basic    *
 * input variables alpha, alpha_s, QCD scale, Fermi constant G_F, the Z-boson  *
