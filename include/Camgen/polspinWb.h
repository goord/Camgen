...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Specialisation of the massive polarised spinor factory in the Weyl basis of *
 * gamma matrices. This header cannot be included stand-alone, it can only be  *
 * included through the files Weyl_basis.h or polarised_type.h                 *
 *                                                                             *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

namespace Camgen
{
    template<class value_t>class massive_spinor_factory<typename Weyl_basis::template implementation<value_t,4,true>,polarised_type,3,4>: public massless_spinor_factory<typename Weyl_basis::template implementation<value_t,4,true>,3,4>
    {
	public:
	...
	public:
		...
		value_type c(e-(*p)[1]+(*p)[3],(*p)[2]);
		c/=((r_value_type)2*std::sqrt(e*(e*((*p)[0]-(*p)[1]+(*p)[3])-(*p)[1]*(*p)[3])));
		it[0]+=c*(e-(*p)[3]);
