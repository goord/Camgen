...
#ifndef CAMGEN_SFFR_H_
#define CAMGEN_SFFR_H_

#include <Camgen/def_args.h>

/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Declaration and definition of the right-handed scalar-fermion-fermion vertex. *
 *                                                                               *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Camgen
{
    ...
    template<class model_t>class sffR
    {
	public:
    ...
    template<class model_t>const std::size_t sffR<model_t>::spinor_size;
    template<class model_t>const std::size_t sffR<model_t>::rank;
    template<class model_t>const std::size_t sffR<model_t>::params;
    template<class model_t>const std::size_t sffR<model_t>::tensor_size;
    template<class model_t>const bool sffR<model_t>::p_dependent;
    template<class model_t>const bool sffR<model_t>::fermionic;
    template<class model_t>const std::size_t sffR<model_t>::sizes[4]={1,sffR<model_t>::spinor_size,sffR<model_t>::spinor_size,0};
    template<class model_t>const std::string sffR<model_t>::formula="(1-g_5)(i,j)/2";

    /* Specialisation of the evaluate class template: */

    template<class model_t>class evaluate<sffR<model_t> >
    {
	public:

	    /* Reference type definition of the vertex type: */

	    typedef sffR<model_t> vertex_type;
	...
	public:
	    ...
	    /* Recursive relations, calling the gR-recursive relations in the
	     * Dirac algebra class: */

	    static void first(ARG_LIST)
	    {
		Dirac_algebra_type::gR_first(factor*C_0,A_0,A_1,A_2);
	    }
	    static void second(ARG_LIST)
	    {
		Dirac_algebra_type::gR_second(factor*C_0,A_0,A_1,A_2);
	    }
	    static void third(ARG_LIST)
	    {
		Dirac_algebra_type::gR_third(factor*C_0,A_0,A_1,A_2);
	    }
	    static void fourth(ARG_LIST){}

	    /* Right charge conjugate recursive relations, calling the
	     * gR_C-recursive relations in the Dirac algebra class: */

	    static void first_C(ARG_LIST)
	    {
		Dirac_algebra_type::gR_C_first(factor*C_0,A_0,A_1,A_2);
	    }
	    static void second_C(ARG_LIST)
	    {
		Dirac_algebra_type::gR_C_second(factor*C_0,A_0,A_1,A_2);
	    }
	    static void third_C(ARG_LIST)
	    {
		Dirac_algebra_type::gR_C_third(factor*C_0,A_0,A_1,A_2);
	    }
	    static void fourth_C(ARG_LIST){}

	    /* Left charge conjugate recursive relations, calling the
	     * Cc_gR-recursive relations in the Dirac algebra class: */

	    static void Cc_first(ARG_LIST)
	    {
		Dirac_algebra_type::Cc_gR_first(factor*C_0,A_0,A_1,A_2);
	    }
	    static void Cc_second(ARG_LIST)
	    {
		Dirac_algebra_type::Cc_gR_second(factor*C_0,A_0,A_1,A_2);
	    }
	    static void Cc_third(ARG_LIST)
	    {
		Dirac_algebra_type::Cc_gR_third(factor*C_0,A_0,A_1,A_2);
	    }
	    ...
	    /* Right charge conjugate reversed recursive relations, using gL_C
	     * if the sign is -1: */
	    ...
	    /* Left charge conjugate reversed recursive relations, using Cc_gL
	     * if the sign is -1: */
    ...
    template<class model_t>const std::size_t evaluate< sffR<model_t> >::spinor_size;
    template<class model_t>const int evaluate< sffR<model_t> >::sign;
}

#include <Camgen/undef_args.h>

#endif /*CAMGEN_SFFR_H_*/
