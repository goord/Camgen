...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Specialisation of the massive Kleiss_Stirling spinor factory in the Weyl    *
 * basis of gamma matrices. This header cannot be included stand-alone, it can *
 * only be included through the files Weyl_basis.h or KS_type.h                *
 *                                                                             *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

namespace Camgen
{
    template<class value_t>class massive_spinor_factory<typename Weyl_basis::template implementation<value_t,4,true>,KS_type,3,4>: public massless_spinor_factory<typename Weyl_basis::template implementation<value_t,4,true>,3,4>
    {
	public:
